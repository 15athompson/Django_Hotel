...
class TestDataGenerator(TestCase):
    ...
    def create_reservations(self):
        ...
        Reservation.objects.create(
            ...
            reservation_date_time=datetime.now() - timedelta(days=7),
            price=Decimal('300.00'),
        ...
        Reservation.objects.create(
            ...
            reservation_date_time=datetime.now() - timedelta(days=14),
        ...
        Reservation.objects.create(
            ...
            reservation_date_time=datetime.now() - timedelta(days=30),
